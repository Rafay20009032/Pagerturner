...
<section class="contactpage">
      ...
      <div class="contactoptions">
        <div class="contactsales">
          ...
          <h2>Talk to Sales</h2>
          <p>Interested in Learning? Just pick up the phone to chat with a member of our sales team.</p>
          <a href="#">+623 456 7890</a>
        </div>
        <div class="contactsupport">
          ...
          <a href="mailto:support@example.com">pageturner@example.com</a>
        </div>
      </div>
    </div>
  </section>
  <h1 style="color: #fff; padding: 10px; text-align: center;">
      Testimonials
    </h1>
    <section class="body">
      <div id="container">
          ...
          // Fetch testimonials with user details
          $query = "
          ...
          if ($result && $result->num_rows > 0) {
              // Display each testimonial dynamically
              while ($row = $result->fetch_assoc()) {
                  $user_name = htmlspecialchars($row['Name']);
                  $comments = htmlspecialchars($row['Comments']);
                  $user_image = !empty($row['Image']) ? 'data:image/jpeg;base64,' . base64_encode($row['Image']) : '../Images/default_user.png'; // Default image if not available
    ...
    <div class="contactuss">
      ...
      <div class="contactform">
          ...
          <form id="contactForm" method="POST" action="../methods.php">
            <input type="hidden" name="form_action" value="testimonial_form">
            <div class="formgroup">
